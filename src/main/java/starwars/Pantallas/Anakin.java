 ...
 */
public class Anakin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 600, -1, -1));

        HanSolo.setFont(new java.awt.Font("Herculanum", 1, 36)); // NOI18N
        HanSolo.setForeground(new java.awt.Color(255, 255, 255));
        HanSolo.setText("Anakin");
        getContentPane().add(HanSolo, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 480, 190, 60));
        ...
        imagen.setBackground(new java.awt.Color(255, 255, 0));
        imagen.setForeground(new java.awt.Color(51, 255, 51));
        imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/starwars/imagenes/Anakin_Skywalker_Easy-Resize.com_Easy-Resize.com.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Anakin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
