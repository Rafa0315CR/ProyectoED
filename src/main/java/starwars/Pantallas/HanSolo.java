 ...
 */
public class HanSolo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 590, -1, -1));

        HanSolo.setFont(new java.awt.Font("Herculanum", 1, 36)); // NOI18N
        HanSolo.setForeground(new java.awt.Color(255, 255, 255));
        HanSolo.setText("Han Solo");
        getContentPane().add(HanSolo, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 490, 190, 60));

        Poder.setFont(new java.awt.Font("Herculanum", 0, 24)); // NOI18N
        Poder.setForeground(new java.awt.Color(255, 255, 255));
        Poder.setText("Poder: 400");
        ...
        imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/starwars/imagenes/HAN_SOLO_Easy-Resize.com_Easy-Resize.com.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HanSolo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
