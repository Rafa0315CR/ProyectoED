 ...
 */
public class Wicket extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Cerrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 590, -1, -1));

        Wicket.setFont(new java.awt.Font("Herculanum", 1, 36)); // NOI18N
        Wicket.setForeground(new java.awt.Color(255, 255, 255));
        Wicket.setText("Wicket");
        getContentPane().add(Wicket, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 490, 190, 60));

        Poder.setFont(new java.awt.Font("Herculanum", 0, 24)); // NOI18N
        Poder.setForeground(new java.awt.Color(255, 255, 255));
        Poder.setText("Poder: 190");
        getContentPane().add(Poder, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 540, -1, -1));

        Arrma.setFont(new java.awt.Font("Herculanum", 0, 24)); // NOI18N
        Arrma.setForeground(new java.awt.Color(255, 255, 255));
        Arrma.setText("Arma: Nimguna  ");
        getContentPane().add(Arrma, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 570, 340, -1));

        imagen.setIcon(new javax.swing.ImageIcon(getClass().getResource("/starwars/imagenes/Wicket_W._Easy-Resize.com_Easy-Resize.com.jpg"))); // NOI18N
        ...
        Bueno.setText("Malo");
        getContentPane().add(Bueno, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 500, 80, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Wicket.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
