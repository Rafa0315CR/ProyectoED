 ...
 * @author valen
 */
public class ListaTodos extends javax.swing.JFrame {

    /**
     * Creates new form ListaTodos
     */
    public ListaTodos() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListaTodos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListaTodos().setVisible(true);
            }
        });
    }
    ...
    public javax.swing.JTable tblTodos;
